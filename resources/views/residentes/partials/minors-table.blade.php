    ...
    <table class="min-w-full bg-white">
        <thead class="hidden md:table-header-group">
            <tr class="bg-gray-100 text-gray-600 uppercase text-sm">
                <th class="py-3 px-5 text-left">Nombre<span class="text-red-600 ml-1">*</span></th>
                <th class="py-3 px-4 text-left">Edad<span class="text-red-600 ml-1">*</span></th>
                <th class="py-3 px-4 text-left">Género<span class="text-red-600 ml-1">*</span></th>
